	...
	m_nodeCount(0)
{
	...
	m_next = static_cast<unsigned short*>(dtAlloc(sizeof(unsigned short)*m_maxNodes, DT_ALLOC_PERM));
	m_first = static_cast<unsigned short*>(dtAlloc(sizeof(unsigned short)*hashSize, DT_ALLOC_PERM));
